...
$i18n = [
    ...
    "income_management" => "Einnahmenverwaltung",
    "add_income" => "Einnahme erfassen",
    "edit_income" => "Einnahme bearbeiten",
    "income_type" => "Einnahme-Typ",
    "income_date" => "Einnahme-Datum",
    "linked_subscription" => "Zugeordnetes Abo (optional)",
    "recurring_frequency" => "Abrechnungsfrequenz",
    "end_date" => "Enddatum",
    "one_time_income" => "Einmalige Einnahme",
    "recurring_income" => "Wiederkehrende Einnahme",
    "income_entries" => "Einnahme-Einträge",
    "amount" => "Betrag",
    "all" => "Alle",
    "person_ledger" => "Personenabrechnung",
    "current_month" => "Aktueller Monat",
    "current_year" => "Aktuelles Jahr",
    "custom_range" => "Zeitraum",
    "total_period" => "Gesamter Zeitraum",
    "history" => "Historie",
    "expenses_total" => "Ausgaben gesamt",
